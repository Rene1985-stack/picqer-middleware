...
// Supplier-specific attributes (MODIFIED - removed created_at and updated_at)
const supplierAttributes = [
  { apiField: "idsupplier", dbColumn: "id", type: "string", required: true },
  { apiField: "name", dbColumn: "name", type: "string", required: true }
  // { apiField: "created", dbColumn: "created_at", type: "datetime", required: false }, // Removed
  // { apiField: "updated", dbColumn: "updated_at", type: "datetime", required: false }  // Removed
];
